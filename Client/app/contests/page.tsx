          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-600">
                Manage and monitor your created contests
              </p>
            </div>
          </div>
          <div className="group">
              ...
              >
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    {/* Contest Link */}
                    <div className="p-2 bg-slate-50 rounded text-xs font-mono break-all">
                      {contest.link}
                    </div>
                    ...
                    <div className="flex space-x-2 pt-2">
                      <Button
                        ...
                        onClick={() =>
                          router.push(
                            `/contest-waiting?contestId=${contest.id}`
                          )
                        }
                      >
                      ...
                      contest.userName ? (
                        <Button
                          ...
                          className="flex-1"
                          onClick={() =>
                            router.push(`/edit-contest/${contest.id}`)
                          }
                        >
                      ...
                      contest.userName ? (
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setDelete_id(contest.id);
                            console.log("Delete button clicked", delete_id);
                          }}
                        >
